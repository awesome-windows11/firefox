...
| Параметр                             | Firefox Release            | Unbranded Release         |
| ------------------------------------ | -------------------------- | ------------------------- |
| Код соответствующей версии Firefox   | ✅                          | ✅ практически тот же      |
| Обязательная подпись XPI             | ✅                          | ❌ можно отключить         |
| Branding                             | Firefox                    | unofficial                |
| Канал обновлений                     | `release`                  | `default`                 |
| Автоматические обновления Mozilla    | ✅                          | **❌**                     |
| Языки готовой сборки                 | много                      | **en-US only**            |
| Проверка наличия версии              | каждые 6 ч                 | каждые 24 ч               |
| Большой update prompt                | через 8 дней               | через 1 день              |
| Проверка «слишком старой» установки  | 63 дня                     | 2 дня                     |
| Значок ожидающего обновления         | через 4 дня                | сразу                     |
| Welcome page                         | `about:welcome`            | пустая                    |
| Self-XSS защита DevTools при вставке | стандартное предупреждение | порог уже выставлен в `5` |
...
Win32 - https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/YTMv_nd9T5ucNwP6gsP8bA/runs/0/artifacts/public/build/target.zip
<br>
Win64 - https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/CapnPdAbQemn76V4BJVfeA/runs/0/artifacts/public/build/target.zip
...
<br>
Win64 - https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/QBrz_EfsTlOMwE0GurheiA/runs/1/artifacts/public/build/target.zip

### Firefox 133.0.3 [7ed49fe90e84](https://hg.mozilla.org/releases/mozilla-release/rev/7ed49fe90e84)
Win32 - https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/EaKOLqRESJWFJ1rQRW2v7g/runs/0/artifacts/public/build/target.zip
<br>
Win64 - https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/T5PULZy6SxyvQlt51kyT7A/runs/0/artifacts/public/build/target.zip
